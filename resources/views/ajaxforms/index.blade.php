            ...
            <div class="card-body">
                ...
                <div class="col-12 justify-content-start">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('birthday', null, ['class' => 'form-control', 'id' => 'birthday', 'readonly']) }}
                    </div>
                    <div class="form-group">
...
{{--                        {{ Form::select('country', array('Ukraine' => 'Ukraine', 'Germany' => 'Germany'), null, ['class' => 'form-control field']) }}--}}
                    ...
                    <div class="form-group">
                        {{ Form::label('email', 'Email (example@example.com) *') }}
                        {{ Form::text('email', null, ['class' => 'form-control']) }}
                    </div>
                    {{ Form::submit('Next', ['class' => 'btn btn-primary', 'id' => 'btn','onclick' => 'ajaxForm.storeMainForm(event)']) }}
                    {{ Form::close() }}
                </div>
